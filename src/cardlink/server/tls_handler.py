...
Example:
    >>> from cardlink.server.tls_handler import TLSHandler
...
from cardlink.server.config import CipherConfig
...
class TLSHandler:
    ...
    def __init__(
        ...
        # Log max fragment length configuration per GP spec Table 3-2
        # Note: OpenSSL handles RFC 6066 max_fragment_length extension automatically
        # when client requests it in ClientHello
        if self._cipher_config.max_fragment_length:
            logger.info(
