...
def status(ctx: click.Context, verbose: bool) -> None:
    ...
    """
    try:
        from cardlink.database import DatabaseConfig, DatabaseManager, UnitOfWork
...
def rollback(ctx: click.Context, revision: str, confirm: bool) -> None:
    ...
    """
    try:
        from cardlink.database.migrate import downgrade, get_current_revision
...
def history(ctx: click.Context) -> None:
    ...
    """
    try:
        from cardlink.database.migrate import get_migration_history
