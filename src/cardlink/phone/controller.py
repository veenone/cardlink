...
from cardlink.phone.exceptions import ADBNotFoundError, DeviceNotFoundError
from cardlink.phone.models import ADBDevice, BIPEvent, DeviceState
...
class PhoneController:
    ...
    async def get_device(self, serial: str) -> Device:
        ...
        if device_info.state == DeviceState.UNAUTHORIZED:
            from cardlink.phone.exceptions import DeviceUnauthorizedError
