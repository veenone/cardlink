...
Example:
    >>> from gp_ota_tester.database.models import OTASession, SessionStatus
    >>> session = OTASession(
...
from gp_ota_tester.database.models.base import Base, TimestampMixin, generate_uuid
from gp_ota_tester.database.models.enums import SessionStatus
