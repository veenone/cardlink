...
def profile_save(ctx: click.Context, serial: str, name: str, force: bool) -> None:
    ...
    """
    try:
        from gp_ota_tester.phone import PhoneController, ProfileManager
...
def profile_load(ctx: click.Context, name: str, json_output: bool) -> None:
    ...
    """
    try:
        from gp_ota_tester.phone import ProfileManager
        ...
        # Display summary
        from gp_ota_tester.phone.profile_manager import ProfileManager as PM
