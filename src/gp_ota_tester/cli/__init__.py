...
from gp_ota_tester.cli.server import cli, start, stop
from gp_ota_tester.cli.modem import cli as modem_cli
from gp_ota_tester.cli.phone import cli as phone_cli
